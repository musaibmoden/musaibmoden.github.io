      ...
      <div className="bg-black border border-green-500 rounded-lg overflow-hidden shadow-lg shadow-green-500/20">
        <div className="flex items-center justify-between bg-black px-4 py-2 border-b border-green-500/50">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-green-500 font-bold">musaib@portfolio:{currentDirectory}</h2>
          </div>
        </div>
        <div 
          ref={terminalRef}
        ...
        >
          ...
          <motion.div
            ...
            className="mb-4"
          >
            <pre className="text-green-400 text-xs sm:text-sm lg:text-base whitespace-pre-wrap" suppressHydrationWarning={true}>
{`
███    ███ ██    ██ ███████  █████  ██ ██████      ███████  █████       ██      ██  █████  ██████  
████  ████ ██    ██ ██      ██   ██ ██ ██   ██     ██      ██   ██      ██      ██ ██   ██ ██   ██ 
██ ████ ██ ██    ██ ███████ ███████ ██ ██████      ███████ ███████      ██      ██ ███████ ██   ██ 
